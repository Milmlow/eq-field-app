...
// S1 Phase 2 — sliding-window scope. The timesheets page only ever
// renders the current week (renderTimesheets uses STATE.currentWeek),
// so a windowed fetch here is sufficient + keeps the payload bounded.
